...
public class CategoryServiceImpl implements CategoryService{
    ...
    @Override
    public PaginationResponse<Category> getAll(PaginationRequest paginationRequest) {
        Page<Category> page = categoryRepository.findAll(paginationRequest.toPageable());
